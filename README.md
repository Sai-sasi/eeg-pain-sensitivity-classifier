...
# EEG-Based Classification of Pain Sensitivity
...
**Features:** 7 pre-extracted EEG features per subject — N2 and P2 latency and amplitude, N-P peak-to-peak amplitude, peak alpha frequency, and alpha power.
...
Sai — MSc Brain Sciences, University of Glasgow. Background in electrophysiology and computational neuroscience.
